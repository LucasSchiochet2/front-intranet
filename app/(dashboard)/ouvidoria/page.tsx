    ...
    <div className="container  mx-auto py-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
        <Link 
          ...
          className="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-200 group"
        >
          <div className="p-4 bg-green-50 rounded-full mb-4 group-hover:bg-green-100 transition-colors">
            <FileText className="w-8 h-8 text-primary" />
          </div>
          <h2 className="text-xl font-semibold text-secondary mb-2">Nova Solicitação</h2>
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-secondary mb-2">Acompanhamento</h2>
          <p className="text-gray-600 text-center">
